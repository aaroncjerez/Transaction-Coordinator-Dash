 ...
 */
export function calculateScaleProgress(currentWeek, businessMetrics = null) {
    if (!currentWeek)
        return null;
 ...
 */
export function getGoalPercentage(actual, goal) {
    if (goal === 0)
        return 0;
 ...
 */
export function getScaleProgressStatus(percentage) {
    if (percentage >= 100)
        return 'green';
    if (percentage >= 50)
        return 'yellow';
 ...
 */
function generateHalfMillionInsights(progress, current) {
    const insights = [];
 ...
 */
export function calculateHalfMillionProgress(weekData, businessMetrics) {
...
//# sourceMappingURL=scale-calculations.js.map