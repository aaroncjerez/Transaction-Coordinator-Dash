...
import { Home, LayoutGrid, CheckSquare, Flame, Phone, BarChart3, TrendingUp, Archive, Settings, Landmark } from 'lucide-react';
  ...
  return (
    <aside className="hidden md:flex w-56 bg-sidebar flex-col h-screen fixed left-0 top-0 z-40">
      ...
      <nav className="flex-1 mt-1 space-y-0.5" aria-label="Main navigation">
        ...
        <NavItem to="/dialer" icon={Phone} label="AI Dialer" />
