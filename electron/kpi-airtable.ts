...
function parseAirtableWeekRecord(record: AirtableWeeklyRecord): ParsedWeekData {
  ...
  const teamMembers = [
    ...
    },
    {
      id: 'edward',
      name: 'Edward',
      textsSent: record['Total Texts Sent - Edward'] || 0,
      callsMade: record['Edward Logged Calls'] || 0,
      totalLeadsText: record['Edward Total Leads'] || 0,
      totalLeadsCall: 0,
    ...
    },
    {
      ...
      hotLeadsText: 0,
      hotLeadsCall: record['Maria Hot Leads'] || 0,
    ...
    },
    {
      id: 'justine',
      name: 'Justine',
      textsSent: record['Total Texts Sent - Justine'] || 0,
      callsMade: 0,
      totalLeadsText: record['Justine Total Leads'] || 0,
      totalLeadsCall: 0,
      hotLeadsText: record['Justine Hot Leads'] || 0,
      hotLeadsCall: 0,
      offersSent: record['Justine Offers Shared'] || 0,
      contractsSent: 0,
      contractsSigned: 0,
      leadsPriced: record['Justine Total leads priced'] || 0,
      medianPricingSpeed: record['Justine Median Pricing Speed'] || 0,
    },
    {
      id: 'aaron',
      name: 'Aaron',
      ...
      hotLeadsText: 0,
      hotLeadsCall: 0,
      offersSent: record['Aaron Real Offers Shared'] || 0, // CRITICAL: Real offers, not total offers
      contractsSent: record['Contracts Signed'] || 0, // When seller SIGNS contract (target: 0.65/week)
      contractsSigned: record['Contracts Sent to Title'] || 0, // When deal CLOSES, sent to title (target: 0.455/week - 70% of signed)
    },
  ];
